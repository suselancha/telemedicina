...
<div class="messenger">
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">Sin Internet</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Seleccione un usuario para comenzar a enviar mensajes.</span></p>
            </div>
            {{-- Typing indicator --}}
